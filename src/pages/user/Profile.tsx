                        ...
                        isFavorite ?
                            ...
                            <motion.div
                                ...
                                <div className="flex items-center justify-between mb-10">
                                    ...
                                    <Button startIcon={<FaEdit />} href="/user/profile/edit">Edit</Button>
                                </div>
                                <div className="flex justify-between flex-wrap">
                                    ...
                                    <div className="flex items-center md:w-[40%] m-4">
                                        ...
                                        <div className="ml-4">
                                            <Typography className="font-semibold">0857-8515-3695</Typography>
                                    ...
                                    <div className="flex items-center md:w-[40%] m-4">
                                        ...
                                        <div className="ml-4">
                                            <Typography className="font-semibold">May, 21 2002</Typography>
                                    ...
                                    <div className="flex items-center md:w-[40%] m-4">
                                        ...
                                        <div className="ml-4">
                                            <Typography className="font-semibold text-blue-600 underline">
                                                <a href="https://www.instagram.com/red_o_21/" target="_blank" rel="noreferrer">Click here</a>
                                            </Typography>
                                ...
                                <div className="flex flex-col">
                                    <div className="flex items-center m-4">
                                        ...
                                        <div className="ml-4">
                                            <Typography className="font-semibold">Jalan Bagusan, Desa Terusan, Gedeg, Mojokerto</Typography>
                                            <Typography className="text-gray-500 text-sm">location</Typography>
                                        </div>
                                    </div>
                                    <div className="flex items-center m-4">
