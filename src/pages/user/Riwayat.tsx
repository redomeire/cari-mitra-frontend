    ...
    return ( 
        <AppLayout>
            <div className="mx-10 flex items-start relative">
                ...
                <div className="border bg-white p-4 ml-4">
                ...
                <div className="mt-5">
                    {
                        ...
                        riwayats.filter((riwayat: { status: string }) => {
                            ...
                            return(
                                <div key={index} className="p-4 rounded-lg border my-2 flex items-start">
    ...
    return (
        <div className="md:min-w-[20%] p-4 border w-fit bg-white sticky top-[85px]">
            <div className="food my-5">
                ...
                <div onClick={() => setFilterRiwayat('semua')} className={`cursor-pointer flex items-center p-3 my-3 ${filterRiwayat === 'semua' ? 'border-r-2 border-r-black' : ''}`}>
                    <Typography className="font-[500] text-sm uppercase">Semua</Typography>
                </div>
                <div onClick={() => setFilterRiwayat('berlangsung')} className={`cursor-pointer flex items-center p-3 my-3 ${filterRiwayat === 'berlangsung' ? 'border-r-2 border-r-black' : ''}`}>
                    <Typography className="font-[500] text-sm uppercase">Berlangsung</Typography>
                </div>
                <div onClick={() => setFilterRiwayat('gagal')}  className={`cursor-pointer flex items-center p-3 my-3 ${filterRiwayat === 'gagal' ? 'border-r-2 border-r-black' : ''}`}>
