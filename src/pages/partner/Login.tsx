...
const Login = () => {
    ...
    const handleSubmit = (e: { preventDefault: () => void }) => {
        ...
        axios.post('http://localhost:3333/api/partner/login', {
            email: email,
            password: password
        })
            .then(res => {
    ...
    return (
        ...
        <div className="flex items-stretch min-h-screen font-sora">
            ...
            <div className="p-14 md:w-1/2">
                <Typography variant="subtitle1">Login for partner</Typography>
                ...
                <form className="mt-5" onSubmit={handleSubmit}>
                    ...
                    <Typography className="text-[14px] mt-4">Not registered yet? <a href="/partner/register"><span className="font-semibold">Create an account</span></a></Typography>
                </form>
            </div>
